...
if(FALSE){
    ...
    setwd("./Elkhart_PantryMap")
}

load("allData.RData")
locations <- locations.elk
form.responces <- form.responces.elk
...
ui <- navbarPage("Elkhart Food Pantry Explorer", theme = shinytheme("yeti"), selected = "Individual Reports",
    tabPanel("Map",
            sidebarLayout(
                sidebarPanel(
